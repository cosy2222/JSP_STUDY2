...
<body>
	...
	try{
		...
		if(rs.next()){
			...
			if(eno.equals(reno)){
				sql = "update emp_copy set ename = '" + ename + "' , job = '" + job + "' , manager = " + manager + " , hiredate = to_date(" + hiredate + ", 'yyyymmdd')"+ ",salary = " + salary +" , commission = " + commission + ", dno = " + dno + " where eno = "+ eno ;
				stmt = conn.createStatement();
